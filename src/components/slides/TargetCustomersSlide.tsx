      ...
      <div className="slide-content">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="gradient-card animate-slide-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <TrendingUp className="text-ofbusiness-green mt-1 flex-shrink-0" size={20} />
                    <div>
                      <h4 className="font-medium text-ofbusiness-dark">Growth Needs</h4>
                      <ul className="space-y-2 text-ofbusiness-gray mt-2">
                        <li className="flex items-start gap-2">
                          <span className="text-ofbusiness-green font-bold">•</span>
                          <span>Seeking to optimize working capital</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-ofbusiness-green font-bold">•</span>
                          <span>Looking for better business opportunities and tenders</span>
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            <div className="gradient-card animate-slide-in" style={{animationDelay: '0.2s'}}>
              <div className="flex items-center gap-3 mb-4">
